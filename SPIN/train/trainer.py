...
class Trainer(BaseTrainer):
    def init_fn(self):
        ...
        self.model = hmr(config.SMPL_MEAN_PARAMS, pretrained=True)
    ...
    def train_step(self, input_batch):
        ...
        is_flipped = input_batch["is_flipped"].type(
            torch.bool
        ...
        opt_pose, opt_betas, valid_fit = self.fits_dict[
        ...
        valid_fit = valid_fit.to(self.device)
